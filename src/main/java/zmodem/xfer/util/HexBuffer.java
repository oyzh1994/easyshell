...
public class HexBuffer implements Buffer {
    ...
    public zmodem.xfer.util.ByteBuffer asByteBuffer() {
        return new ByteBuffer(_wrapped);
    }

    public short getShort() {
        return zmodem.xfer.util.Arrays.toShort(new byte[]{get(), get()}, Endianness.Little);
    }

    public Buffer putShort(short value) {
        return put(zmodem.xfer.util.Arrays.fromShort(value, Endianness.Little));
    }

    public short getShort(int index) {
        return zmodem.xfer.util.Arrays.toShort(new byte[]{get(index), get(index + 1)}, Endianness.Little);
    }

    public Buffer putShort(int index, short value) {
        return put(index, zmodem.xfer.util.Arrays.fromShort(value, Endianness.Little));
    }

    public int getInt() {
        return zmodem.xfer.util.Arrays.toInt(new byte[]{get(), get(), get(), get()}, Endianness.Little);
    }

    public Buffer putInt(int value) {
        return put(zmodem.xfer.util.Arrays.fromInt(value, Endianness.Little));
    }

    public int getInt(int index) {
        return zmodem.xfer.util.Arrays.toInt(new byte[]{get(index), get(index + 1), get(index + 2), get(index + 3)}, Endianness.Little);
    }

    public Buffer putInt(int index, int value) {
        return put(index, zmodem.xfer.util.Arrays.fromInt(value, Endianness.Little));
    }

    public long getLong() {
        return zmodem.xfer.util.Arrays.toLong(new byte[]{get(), get(), get(), get(), get(), get(), get(), get()}, Endianness.Little);
    }

    public Buffer putLong(long value) {
        return put(zmodem.xfer.util.Arrays.fromLong(value, Endianness.Little));
    }

    public long getLong(int index) {
        return zmodem.xfer.util.Arrays.toLong(new byte[]{get(index), get(index + 1), get(index + 2), get(index + 3), get(index + 4), get(index + 5), get(index + 6), get(index + 7)}, Endianness.Little);
    }
