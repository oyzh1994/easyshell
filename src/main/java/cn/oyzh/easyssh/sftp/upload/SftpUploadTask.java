...
//        this.totalCountProperty.set(this.totalCount.incrementAndGet());
//        this.totalSizeProperty.set(NumberUtil.formatSize(this.totalSize.addAndGet(file.length()), 2));
