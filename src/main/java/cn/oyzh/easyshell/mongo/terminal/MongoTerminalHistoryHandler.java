 ...
 * @since 2023/8/28
 */
public class MongoTerminalHistoryHandler extends BaseTerminalHistoryHandler {

    /**
     * 当前实例
     */
    public static final MongoTerminalHistoryHandler INSTANCE = new MongoTerminalHistoryHandler();
