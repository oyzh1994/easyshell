package cn.oyzh.easyshell.mongo.controller.data;
...
@StageAttribute(
        ...
        value = FXConst.FXML_PATH + "mongo/data/shellMongoDataTransport.fxml"
)
public class ShellMongoDataTransportController extends StageController {
     ...
     * 来源客户端
     */
    private ShellMongoClient sourceClient;

    /**
     * 目标客户端
     */
    private ShellMongoClient targetClient;
