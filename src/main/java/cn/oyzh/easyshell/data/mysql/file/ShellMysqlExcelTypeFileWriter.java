 ...
 * @since 2024-09-04
 */
public class ShellMysqlExcelTypeFileWriter extends ShellMysqlTypeFileWriter {
    ...
    public ShellMysqlExcelTypeFileWriter(String filePath, DBDataExportConfig config, MysqlColumns columns) throws IOException {
