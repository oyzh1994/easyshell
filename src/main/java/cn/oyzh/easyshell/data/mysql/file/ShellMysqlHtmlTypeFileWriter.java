 ...
 * @since 2024-09-04
 */
public class ShellMysqlHtmlTypeFileWriter extends ShellMysqlTypeFileWriter {
    ...
    public ShellMysqlHtmlTypeFileWriter(String filePath, DBDataExportConfig config, MysqlColumns columns) throws FileNotFoundException {
