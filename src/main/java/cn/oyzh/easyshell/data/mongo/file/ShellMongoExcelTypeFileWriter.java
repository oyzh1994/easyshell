 ...
 * @since 2024-09-04
 */
public class ShellMongoExcelTypeFileWriter extends ShellMongoTypeFileWriter {
    ...
    public ShellMongoExcelTypeFileWriter(String filePath, DBDataExportConfig config, MongoColumns columns) throws IOException {
    ...
    public void writeHeader() throws Exception {
        ...
        this.xlsRowIndex = 1;
        // 创建一个新的工作表sheet
        Sheet sheet = this.workbook.createSheet(columns.collectionName());
        // 创建列名行
