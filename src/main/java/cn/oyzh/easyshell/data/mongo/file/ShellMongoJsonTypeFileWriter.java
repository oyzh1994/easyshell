 ...
 * @since 2024-09-04
 */
public class ShellMongoJsonTypeFileWriter extends ShellMongoTypeFileWriter {
    ...
    public ShellMongoJsonTypeFileWriter(String filePath, ShellMongoDataExportConfig config, MongoColumns columns) throws FileNotFoundException {
