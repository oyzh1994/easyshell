 ...
 * @since 2024-09-03
 */
public class ShellMongoJsonTypeFileReader extends ShellMongoTypeFileReader {
    ...
    public ShellMongoJsonTypeFileReader(File file, DBDataImportConfig config) throws FileNotFoundException {
        super(file);
        this.config = config;
