...
import cn.oyzh.easyshell.fx.mysql.table.ShellMysqlColumnListView;
...
public class ShellMysqlColumnFieldPopupController extends PopupController {
     ...
     */
    @FXML
    private ShellMysqlColumnListView listView;
