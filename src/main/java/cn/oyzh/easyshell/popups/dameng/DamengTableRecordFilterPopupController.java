...
// */
//@PopupAttribute(
//        value = FXConst.POPUP_PATH + "dameng/shellDamengTableRecordFilterPopup.fxml",
//        arrowLocation = BOTTOM_LEFT,
//        anchorLocation = CONTENT_TOP_LEFT
//)
//public class DamengTableRecordFilterPopupController extends PopupController {
//
//    /**
//     * 表过滤条件表单
//     */
...
//    private void apply() {
//        try {
//            // DamengEventUtil.tableFiltered(this.treeItem, this.filterTable.getItems());
