...
public class ShellZKDataHistory implements ObjectComparator<ShellZKDataHistory>, ObjectCopier<ShellZKDataHistory>, Serializable {
    ...
    @Override
    public boolean compare(ShellZKDataHistory t1) {
        if (t1 == null) {
            return false;
        }
    ...
    @Override
    public void copy(ShellZKDataHistory history) {
