...
//         try {
//             SFTPClient sftpClient = this.sshClient.newSFTPClient();
//             // 设置字符集
//             ShellSFTPChannel sftpChannel = new ShellSFTPChannel(sftpClient, this.realpathManager);
//             return sftpChannel;
//         } catch (Exception ex) {
//             ex.printStackTrace();
//         }
...
//             } else {
//                 channel.put(ShellSFTPProgressMonitor.of(localFile, callback), remoteFile);
//             }
//         }
//     }
//
...
//         RemoteFile file=channel.open(remoteFile);
