package cn.oyzh.easyshell.controller.connect.rlogin;
...
@StageAttribute(
        ...
        value = FXConst.FXML_PATH + "connect/rlogin/shellAddRLoginConnect.fxml"
)
public class ShellAddRLoginConnectController extends StageController {
...
//        }
    ...
    public void onWindowShown(WindowEvent event) {
        ...
        this.osType.selectType(ShellPrototype.RLOGIN);
