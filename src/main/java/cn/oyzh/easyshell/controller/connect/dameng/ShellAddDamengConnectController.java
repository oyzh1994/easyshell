...
@StageAttribute(
        ...
        value = FXConst.FXML_PATH + "connect/dameng/shellAddDamengConnect.fxml"
)
public class ShellAddDamengConnectController extends StageController {
    ...
    private void testConnect() {
        ...
        if (StringUtil.isBlank(host) || StringUtil.isBlank(host.split(":")[0])) {
            ...
            shellConnect.setType(ShellPrototype.DAMENG);
    ...
    public void onWindowShown(WindowEvent event) {
        ...
        this.osType.selectType(ShellPrototype.DAMENG);
