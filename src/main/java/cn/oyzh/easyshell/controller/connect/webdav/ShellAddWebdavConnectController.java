package cn.oyzh.easyshell.controller.connect.webdav;
...
@StageAttribute(
        ...
        value = FXConst.FXML_PATH + "connect/webdav/shellAddWebdavConnect.fxml"
)
public class ShellAddWebdavConnectController extends StageController {
...
//            MessageBox.warn(I18nHelper.contentCanNotEmpty());
    ...
    public void onWindowShown(WindowEvent event) {
        ...
        this.osType.selectType(ShellPrototype.WEBDAV);
