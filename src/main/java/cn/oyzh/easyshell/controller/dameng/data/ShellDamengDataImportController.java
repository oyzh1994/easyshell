...
public class ShellDamengDataImportController extends StageController {
    ...
    private void initFileTable() {
        for (ShellDamengDataImportFile index : this.importFileTableView.itemList()) {
            index.setSchema(this.dbName);
    ...
    private void addFile() {
        ...
        if (file != null) {
            ShellDamengDataImportFile importFile = new ShellDamengDataImportFile();
