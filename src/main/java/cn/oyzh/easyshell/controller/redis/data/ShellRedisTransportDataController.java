...
import cn.oyzh.easyshell.data.handler.redis.ShellRedisDataTransportHandler;
...
public class ShellRedisTransportDataController extends StageController {
     ...
     * 传输处理器
     */
    private ShellRedisDataTransportHandler transportHandler;
    ...
    private void doTransport() {
        ...
        if (this.transportHandler == null) {
            this.transportHandler = new ShellRedisDataTransportHandler();
