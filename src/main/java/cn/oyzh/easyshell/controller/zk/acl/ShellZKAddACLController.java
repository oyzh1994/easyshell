...
@StageAttribute(
        ...
        value = FXConst.FXML_PATH + "zk/acl/shellZKAddACL.fxml"
)
public class ShellZKAddACLController extends StageController {
    ...
    private void addDigestACL3() {
        // 获取内容
        ShellZKAuth zkAuth = this.digestInfo3.getValue();
        if (zkAuth == null) {
