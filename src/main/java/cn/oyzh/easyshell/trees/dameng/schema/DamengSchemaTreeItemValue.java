 ...
 * @since 2023/12/20
 */
public class DamengSchemaTreeItemValue extends RichTreeItemValue {

    public DamengSchemaTreeItemValue(DamengSchemaTreeItem item) {
        super(item);
    }

    @Override
    public DamengSchemaTreeItem item() {
        return (DamengSchemaTreeItem) super.item();
    }
