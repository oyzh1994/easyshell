 ...
 * @since 2024/06/28
 */
public class DamengViewsTreeItemValue extends RichTreeItemValue {

    public DamengViewsTreeItemValue(DamengViewsTreeItem item) {
        super(item);
    }
    ...
    @Override
    public DamengViewsTreeItem item() {
        return (DamengViewsTreeItem) super.item();
    }
