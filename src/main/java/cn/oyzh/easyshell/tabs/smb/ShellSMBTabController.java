 ...
 * @since 2025/04/25
 */
public class ShellSMBTabController extends ShellBaseTabController {
     ...
     */
    @FXML
    private ShellSMBFileTableView fileTable;
    ...
    public void onTabInit(FXTab tab) {
        try {
            ...
            // 监听信息
            this.fileTable.itemList().addListener((ListChangeListener<ShellSMBFile>) c -> {
