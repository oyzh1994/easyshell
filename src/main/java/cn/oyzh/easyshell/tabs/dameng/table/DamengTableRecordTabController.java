 ...
 * @since 2023/12/24
 */
public class DamengTableRecordTabController extends RichTabController {
     ...
     * db树表节点
     */
    private ObjectProperty<DamengTableTreeItem> itemProperty;
     ...
     * @param item db树表节点
     */
    public void init(DamengTableTreeItem item) {
        ...
        if (this.changeListener == null) {
            this.changeListener = new DBStatusListener(this.getItem().schema() + ":" + this.getItem().tableName()) {
                @Override
    ...
    public DamengTableTreeItem getItem() {
    ...
    private void filter() {
        try {
            PopupAdapter popup = PopupManager.parsePopup(DamengTableRecordFilterPopupController.class);
    ...
    private void importData() {
        ShellDamengViewFactory.importData(this.getItem().client(), this.getItem().schema());
    }
