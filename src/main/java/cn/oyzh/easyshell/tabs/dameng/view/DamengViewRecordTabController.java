 ...
 * @since 2024/06/28
 */
public class DamengViewRecordTabController extends RichTabController {
     ...
     * db树视图节点
     */
    private ObjectProperty<DamengViewTreeItem> itemProperty;
     ...
     * @param item db树视图节点
     */
    public void init(DamengViewTreeItem item) {
    ...
    public DamengViewTreeItem getItem() {
