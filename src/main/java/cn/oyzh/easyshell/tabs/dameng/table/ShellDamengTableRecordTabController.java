 ...
 * @since 2023/12/24
 */
public class ShellDamengTableRecordTabController extends RichTabController {
     ...
     * db树表节点
     */
    private ObjectProperty<ShellDamengTableTreeItem> itemProperty;
     ...
     * @param item db树表节点
     */
    public void init(ShellDamengTableTreeItem item) {
