...
public class ShellDamengQueryMainTabController extends RichTabController {
     ...
     */
    @FXML
    private ShellDamengQueryInfoTab infoTab;
     ...
     * @param dbItem db库树节点
     */
    public void init(ShellQuery query, ShellDamengSchemaTreeItem dbItem) {
        // 设置参数
     ...
     * @return tab组件
     */
    private ShellDamengQuerySelectTab initSelectTab(DamengExecuteResult result, String title) {
        ShellDamengQuerySelectTab selectTab = new ShellDamengQuerySelectTab();
     ...
     * @return tab组件
     */
    private ShellDamengQueryExplainTab initExplainTab(DamengExplainResult result, String title) {
        ShellDamengQueryExplainTab selectTab = new ShellDamengQueryExplainTab();
