 ...
 * @since 2024/02/18
 */
public class DamengQueryMainTab extends DamengTab {
    ...
    protected String url() {
        return super.getBasePath() + "query/damengQueryMainTab.fxml";
    }
     ...
     * @param item  db库树节点
     */
    public boolean init(ShellQuery query, DamengSchemaTreeItem item) {
    ...
    @Override
    public DamengQueryMainTabController controller() {
        return (DamengQueryMainTabController) super.controller();
    }
}
