...
import cn.oyzh.easyshell.tabs.dameng.query.DamengQueryExplainTab;
import cn.oyzh.easyshell.tabs.dameng.query.DamengQueryInfoTab;
import cn.oyzh.easyshell.tabs.dameng.query.DamengQuerySelectTab;
 ...
 * @since 2024/02/18
 */
public class DamengQueryMainTabController extends RichTabController {
     ...
     */
    @FXML
    private ShellDamengQueryEditor queryArea;
     ...
     */
    @FXML
    private DamengQueryInfoTab infoTab;
     ...
     * @param dbItem db库树节点
     */
    public void init(ShellQuery query, DamengSchemaTreeItem dbItem) {
        // 设置参数
    ...
    private void doRun(String sql) {
        try {
            ...
            DBQueryResults<DamengExecuteResult> results = this.dbItem.executeSql(sql);
            this.clearTabs();
            int showType = 1;
    ...
    private void explain() {
        try {
            ...
            this.resultTabPane.disable();
            DBQueryResults<DamengExplainResult> results = this.dbItem.explainSql(sql);
            this.clearTabs();
            int showType = 1;
            this.initInfoTab(results);
            if (!results.isEmpty()) {
     ...
     * @return tab组件
     */
    private DamengQuerySelectTab initSelectTab(DamengExecuteResult result, String title) {
        DamengQuerySelectTab selectTab = new DamengQuerySelectTab();
     ...
     * @return tab组件
     */
    private DamengQueryExplainTab initExplainTab(DamengExplainResult result, String title) {
        DamengQueryExplainTab selectTab = new DamengQueryExplainTab();
    ...
    private void save() {
        try {
            ...
            this.query.setDbName(this.dbItem.schema());
