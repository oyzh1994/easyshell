...
public class ShellMongoQueryMainTabController extends RichTabController {
     ...
     * @return tab组件
     */
    private ShellMongoQuerySelectTab initSelectTab(ShellMongoExecuteResult result, String title) {
        ShellMongoQuerySelectTab selectTab = new ShellMongoQuerySelectTab();
