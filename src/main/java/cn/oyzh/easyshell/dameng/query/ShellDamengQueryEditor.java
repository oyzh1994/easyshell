...
import cn.oyzh.easyshell.dameng.query.ShellDamengQueryPromptPopup;
...
public class ShellDamengQueryEditor extends DBQueryEditor {
     ...
     * 提示词组件
     */
    private ShellDamengQueryPromptPopup promptPopup;

    @Override
    protected ShellDamengQueryPromptPopup promptPopup() {
        if (this.promptPopup == null) {
            this.promptPopup = new ShellDamengQueryPromptPopup();
        }
