package cn.oyzh.easyshell.dameng.event;//package cn.oyzh.easyshell.dameng.event;
//
...
// * @since 2024/09/09
// */
//public class DamengEvent extends DBObjectStatus implements ObjectCopier<DamengEvent>, ObjectComparator<DamengEvent> {
//
//    /**
//     * 名称
//     */
...
//
//    @Override
//    public void copy(DamengEvent obj) {
...
//
//    @Override
//    public boolean compare(DamengEvent value) {
//        if (value == null) {
//            return false;
//        }
...
//            return DBUtil.wrapData(val, DBDialect.DAMENG);
//        }
