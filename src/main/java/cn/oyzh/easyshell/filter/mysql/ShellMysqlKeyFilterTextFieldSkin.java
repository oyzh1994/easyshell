 ...
 * @since 2025/11/07
 */
public class ShellMysqlKeyFilterTextFieldSkin extends ClearableTextFieldSkin {
     ...
     * 过滤参数
     */
    private ShellMysqlKeyFilterParam filterParam;

    public ShellMysqlKeyFilterParam filterParam() {
        if (this.filterParam == null) {
            this.filterParam = new ShellMysqlKeyFilterParam();
        }
    ...
    protected void showPopup() {
        ...
        this.popup.setSubmitHandler(o -> {
            if (o instanceof ShellMysqlKeyFilterParam param) {
    ...
    public ShellMysqlKeyFilterTextFieldSkin(TextField textField) {
        super(textField);
        // 初始化按钮
