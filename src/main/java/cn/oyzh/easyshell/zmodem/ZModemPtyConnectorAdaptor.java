...
//     }
//
//     public ZModemPtyConnectorAdaptor(Terminal terminal, FXTerminalPanel terminalPanel, PtyProcessTtyConnector connector) {
...
//         private final FXTerminalPanel terminalPanel;
//         private final Terminal terminal;
//         private final ZModem zmodem;
//         private long lastRefreshTime = 0L;
//
//         public ZModemProcessor(boolean sz, FXTerminalPanel terminalPanel, Terminal terminal, InputStream input, OutputStream output) {
//             this.sz = sz;
//             this.terminalPanel = terminalPanel;
//             this.terminal = terminal;
...
//             Map<String, FileAdapter> files = new HashMap<>();
//             try {
//                 for (File file : openFilesDialog(JFileChooser.FILES_ONLY)) {
//                     files.put(file.getName(), new CustomFile(file));
//                 }
//             } catch (Exception e) {
//             }
//
...
//             //terminal.writeUnwrappedString("\n\r");
//             System.out.println("11111");
//             // zmodem.getNetOs().write(0x07);
//             // zmodem.getNetOs().write(0x04);  // EOT (Ctrl+D)
//             // zmodem.getNetOs().flush();
//
//             // System.out.println();
//             terminal.writeCharacters("\n\r");
//         }
