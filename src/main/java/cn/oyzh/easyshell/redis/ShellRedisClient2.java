...
// * @since 2023/6/16
// */
//public class ShellRedisClient2 implements ShellBaseClient {
//
//    /**
//     * redis命令对象
//     */
...
//    }
//
//    public ShellRedisClient2(ShellConnect shellConnect) {
...
//        RedisClient pool;
//        // 代理配置
//        ShellProxyConfig proxyConfig = null;
//        // ssl工厂
...
//            proxyConfig = this.shellConnect.getProxyConfig();
//        }
//        // 生成socket工厂
//        ShellRedisSocketFactory socketFactory = new ShellRedisSocketFactory(
//                sslSocketFactory,
//                host,
//                port,
//                proxyConfig,
//                clientConfig.getSocketTimeoutMillis()
//        );
//        // 生成连接池
//        ManagedConnectionProvider provider = new ManagedConnectionProvider();
//        provider.setConnection(new Connection(socketFactory, clientConfig));
//        RedisClient.Builder builder = (RedisClient.Builder) RedisClient.builder().clientConfig(clientConfig)
...
//        this.redisClient = pool;
//        this.redisWrapper=new ShellRedisClientWrapper(pool);
//    }
//
//    /**
//     * 初始化连接池配置
...
//     * @return JedisCluster
//     */
//    private RedisClusterClient getCluster() {
...
//
//    private ShellRedisClientWrapper redisWrapper;
//
//    /**
//     * 获取连接
//     *
...
//     * @return RedisClient
//     */
//    private RedisClient getResource(Integer dbIndex) {
//        this.redisClient.pipelined().select(dbIndex);
//        return this.redisClient;
//    }
//
//    /**
...
//     * @param jedis 连接
//     */
//    private void returnResource(RedisClient jedis) {
...
////        RedisClient jedis = this.getResource();
////        try {
...
//        return redisClient==null?null:redisClient.getPool();
...
//        }
//        RedisClient jedis = this.getResource(dbIndex);
//        try {
...
//            return redisWrapper.move(key, targetDBIndex);
//        } finally {
//            this.returnResource(jedis);
//        }
//    }
...
//        RedisClient jedis = this.getResource(dbIndex);
//        try {
//            return jedis.waitReplicas((String) null,replicas, timeout);
//        } finally {
//            this.returnResource(jedis);
//        }
//    }
...
//        RedisClient jedis = this.getResource(dbIndex);
//        try {
//            return jedis.waitAOF((String) null, numLocal, replicas, timeout);
//        } finally {
//            this.returnResource(jedis);
//        }
//    }
...
//        RedisClient jedis = this.getResource(dbIndex);
//        try {
//            return this.redisWrapper.configGet(pattern);
//        } finally {
//            this.returnResource(jedis);
//        }
//    }
...
//     * @return 切换结果
//     */
//    private String dbIndex(RedisClient jedis, Integer dbIndex) {
//        if (jedis == null || this.isClusterMode() || this.isSentinelMode()) {
//            return null;
//        }
//        if (dbIndex == null) {
//            jedis.pipelined().select(this.dbIndex);
//        } else {
...
//        try {
//            if (pattern == null) {
//                return redisWrapper.pubsubChannels();
//            }
//            return this.redisWrapper.pubsubChannels(pattern);
//        } finally {
//            this.returnResource(jedis);
//        }
//    }
...
//        RedisClient jedis = this.getResource(this.dbIndex);
//        try {
//            if (section == null) {
//                return jedis.info();
//            }
...
//        RedisClient jedis = this.getResource(dbIndex);
//        try {
//            return this.redisWrapper.clientList();
//        } finally {
//            this.returnResource(jedis);
//        }
//    }
...
//        RedisClient jedis = this.getResource(dbIndex);
//        try {
//            return this.redisWrapper.slowlogGet();
//        } finally {
//            this.returnResource(jedis);
//        }
//    }
...
//        RedisClient jedis = this.getResource(dbIndex);
//        try {
//            return this.redisWrapper.slowlogGet(entries);
//        } finally {
//            this.returnResource(jedis);
//        }
//    }
...
//        try {
//            this.dbIndex(jedis, dbIndex);
//            return jedis.getPool().getResource().executeCommand(commandObject);
//        } finally {
//            this.returnResource(jedis);
//        }
//    }
...
//
//    @Override
//    public ShellRedisClient2 forkClient() throws Throwable {
//        ShellRedisClient2 redisClient = new ShellRedisClient2(this.shellConnect) {
//            @Override
