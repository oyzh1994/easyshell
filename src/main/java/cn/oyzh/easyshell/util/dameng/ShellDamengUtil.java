...
public class ShellDamengUtil {
    ...
    public static boolean isInternalDatabase(String dbName) {
        return StringUtil.equalsAnyIgnoreCase(dbName, "SYS", "SYSDBA", "SYSSSO", "SYSAUDITOR", "CTISYS");
    }
...
//     * @param record  记录
//     */
//    public static DamengInsertRecordParam toInsertRecordParam(DamengColumns columns, DamengRecord record) {
//        DamengColumn column = columns.getFirst();
//        DamengRecordData recordData = record.getRecordData();
//        DamengRecordPrimaryKey primaryKey = initPrimaryKey(columns, record);
//        DamengInsertRecordParam insertRecordParam = new DamengInsertRecordParam();
...
//    }
     ...
     * @return 主键
     */
    public static DamengRecordPrimaryKey initPrimaryKey(DamengColumns columns, DamengRecord record) {
        if (columns == null || columns.isEmpty()) {
            return null;
        }
        DamengColumn column = CollectionUtil.getFirst(columns.primaryKeys());
        if (column == null) {
            return null;
        }
        DamengRecordPrimaryKey pk = new DamengRecordPrimaryKey();
    ...
    // * @return 结果
    // */
    //public static boolean isFullColumn(String sql) {
