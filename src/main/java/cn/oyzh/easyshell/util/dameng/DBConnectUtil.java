...
//     * @param dbInfo db信息
//     */
//    public static void testConnect(StageAdapter view, DamengConnect dbInfo) {
//        ThreadUtil.start(() -> {
//            try {
//                view.disable();
//                view.waitCursor();
//                view.appendTitle("==连接测试中...");
//                ShellDamengClient client = DBClientUtil.newClient(dbInfo);
//                if (client != null) {
//                    client.start();
...
//     * @param async  是否异步
//     */
//    public static void close(ShellDamengClient client, boolean async) {
//        try {
...
//     * @return 连接
//     */
//    public static DamengConnect parse(String input) {
//        if (input == null) {
//            return null;
//        }
//        try {
//            String[] words = input.split(" ");
//            DamengConnect connect = new DamengConnect();
//            int type = -1;
