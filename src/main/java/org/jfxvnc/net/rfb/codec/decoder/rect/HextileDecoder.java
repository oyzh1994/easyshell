...
//           }
//         }
//         JulLog.trace("hextile (raw): {}x{} {}", partRect.getWidth(), partRect.getHeight(), frame.readableBytes());
...
//         JulLog.trace("hextile (anySubrects): {} {}", subrectCount, subRectColored);
...
//         JulLog.trace("final rects: {}", imageRect);
//         out.add(imageRect);
//         state = State.INIT;
//         return true;
//       }
