...
//
// import cn.oyzh.easyshell.sync.ShellGistOperator;
...
//         ShellGistOperator operator = new ShellGistOperator(accessToken);
//         List<Map<String, Object>> gists = operator.listGists();
//         for (Map<String, Object> gist : gists) {
...
//         // 4. 获取特定文件内容
//         System.out.println("\n=== 文件内容 ===");
//         Map<String,String> javaContent = operator.getFileContent(gistId);
//         if (javaContent != null) {
